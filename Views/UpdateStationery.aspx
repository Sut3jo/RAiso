<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Layout/Navbar.Master" AutoEventWireup="true" CodeBehind="UpdateStationery.aspx.cs" Inherits="ProjectLABPSD.Views.UpdateStationery" %>
        ...
        <div class="container">
            ...
            <div class="inserts">
                <div class="container2">
                    ...
                    <asp:Button CssClass="button" ID="ButtonUpdate" runat="server" Text="Update Item" OnClick="ButtonUpdate_Click" />
